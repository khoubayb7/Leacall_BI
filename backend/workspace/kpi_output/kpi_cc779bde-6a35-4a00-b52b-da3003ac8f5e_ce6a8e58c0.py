...
def generate_kpis(campaign_id: str = "cc779bde-6a35-4a00-b52b-da3003ac8f5e", days_back: int = 30) -> dict:
    window = _build_window(campaign_id, days_back)

    # Mock data for demonstration purposes
    data = [
        {"impressions": 1000, "clicks": 100, "conversions": 10, "spend_usd": 500, "revenue_usd": 1500},
    ]
